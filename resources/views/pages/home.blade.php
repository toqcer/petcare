            ...
            <div class="section-popular-package row justify-content-center">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img
                                src="frontend/images/testi1.jpg"
                                alt="User"
                                class="mb-4 rounded-circle"
                            />
                            <h3 class="mb-4">James Alexander</h3>
                            <p class="testimonial">
                                "Kucing saya Oreo dan Bubu terlihat lebih bersih
                                dan lebih sehat saat melakukan mandi dan juga
                                cek kesehatan di toko PetCare, thanks PetCare!"
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img
                                src="frontend/images/testi2.jpg"
                                alt="User"
                                class="mb-4 rounded-circle"
                            />
                            <h3 class="mb-4">Marissa K. Elba</h3>
                            <p class="testimonial">
                                "Anjing saya sangat menyukai makanan disini,
                                brand yang berkualitas dan terjamin membuat saya
                                percaya dengan PetCare dalam memenuhi kebutuhan
                                Timmy"
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img
                                src="frontend/images/testi3.jpg"
                                alt="User"
                                class="mb-4 rounded-circle"
                            />
                            <h3 class="mb-4">Katrina Salim</h3>
                            <p class="testimonial">
                                "Terima kasih PetCare, hewan peliharaan saya
                                menjadi terawat dengan baik, dari kualitas
                                makanan, dokter, sampai aksesoris semua saya
                                percayakan kepada PetCare"
                            </p>
                        </div>
                    </div>
                </div>
