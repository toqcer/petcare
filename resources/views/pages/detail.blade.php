                            ...
                            <div class="features row">
                                <div class="col-md-4">
                                    <div class="description">
                                        <img 
                                            src="{{ url('frontend/images/ic-spray.png') }}" 
                                            alt="" 
                                ...
                                <div class="col-md-4 border-left">
                                    <div class="description">
                                        <img 
                                            src="{{ url('frontend/images/ic-vit.png') }}" 
                                            alt="" 
                                            class="features-image">
                                        <div class="description">
                                            <h3>Vitamin</h3>
                                ...
                                <div class="col-md-4 border-left">
                                    <div class="description">
                                        <img 
                                            src="{{ url('frontend/images/ic-food.png') }}" 
                                            alt="" 
                                            class="features-image">        
                                        <div class="description">
                                            <h3>Snack Sehat</h3>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                ...
                                <img src="{{ url('frontend/images/memberplus.png') }}" class="member-image mr-1">
                            </div>
                            <hr>
